...
const VideoTitle4 = () => {
  return (
    <div className='w-screen aspect-video absolute text-white pt-[18%] p-12'>
              <h1 className='text-3xl font-bold'>STRANGER THINGS</h1>
              <h4>NEW EPISODES</h4>
              <p className='w-60'>A group of young friends witness supernatural forces and secret government exploits. </p>
